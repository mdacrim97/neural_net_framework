...
int main (int argc, char** argv){
	...
	ActivationFunction leaky = ActivationFunction("leakyReLu", 1.2);
	ActivationFunction linear = ActivationFunction("linear", 1.1);
	ActivationFunction relu = ActivationFunction("reLu");

	//test neural network
	int layerSizes[4] = {2, 4, 2, 1};
	ActivationFunction layerFunctions[3] = {swish, swish, elu};
